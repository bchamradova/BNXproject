...
def getNucleotideShift2d(sides, levels, mid, deviationX, deviationY, mean):
    ...
    for shiftX in np.arange(pixelStartX, pixelEndX, 10):
        for shiftY in np.arange(pixelStartY, pixelEndY, 10):
            ...
            leftCdf = NormalDistribution.getCumulativeValueForRange2d((-1.5, -0.5), (positionX, positionY), deviationX,
                                                                      deviationY,
                                                                      (positionX, positionY))
            rightCdf = NormalDistribution.getCumulativeValueForRange2d((0.5, 1.5), (positionX, positionY), deviationX,
                                                                       deviationY,
                                                                       (positionX, positionY))
            ...
            upCdf = NormalDistribution.getCumulativeValueForRange2d((positionX, positionY), (-1.5, -0.5), deviationX,
                                                                    deviationY,
                                                                    (positionX, positionY))
            downCdf = NormalDistribution.getCumulativeValueForRange2d((positionX, positionY), (0.5, 1.5), deviationX,
                                                                      deviationY,
                                                                      (positionX, positionY))
    ...
    while True:
        ...
        for mark in molecule.fluorescentMarks:
            ...
            if mid>500:
                ...
                shiftX, shiftY = getNucleotideShift2d(sides, levels, mid, sigmaX, sigmaY, mean)
